...
config :photon,
  ...
  # Settings, session logs, the runner's session store and the default workspace.
  data_dir: Path.expand("../.photon", __DIR__),
  # Start an agent node named "local" inside the server. Remote nodes run
  # the `node/` project on their own machines.
  local_node: true
